...
def build_parser() -> argparse.ArgumentParser:
    ...
    usage_summary.add_argument("--home", default=argparse.SUPPRESS)
    ...
    usage_prune.add_argument("--home", default=argparse.SUPPRESS)
    ...
    service_install.add_argument("--home", default=argparse.SUPPRESS)
    ...
    service_uninstall.add_argument("--home", default=argparse.SUPPRESS)
    ...
    for name in ("status", "start", "stop", "restart"):
        ...
        service_cmd.add_argument("--home", default=argparse.SUPPRESS)
    ...
    service_tick.add_argument("--home", default=argparse.SUPPRESS)
    ...
    automation_alcove = automation_sub.add_parser("add-alcove", help="Add an Alcove CLI job")
    automation_alcove.add_argument("--home", default=argparse.SUPPRESS)
    automation_alcove.add_argument("name")
    automation_alcove.add_argument("--args", required=True)
    automation_alcove.add_argument("--cwd", default="")
    automation_alcove.add_argument("--ttl-hours", type=int, default=24)
    automation_alcove.add_argument("--timeout-seconds", type=int, default=600)
    automation_alcove.add_argument("--notify", action="store_true")
    automation_alcove.add_argument("--json", action="store_true")
    automation_agent = automation_sub.add_parser("add-agent", help="Add a guarded agent job")
    automation_agent.add_argument("--home", default=argparse.SUPPRESS)
    automation_agent.add_argument("name")
    automation_agent.add_argument("--prompt", required=True)
    automation_agent.add_argument("--provider", choices=("claude", "codex"), default="claude")
    automation_agent.add_argument("--cwd", default="")
    automation_agent.add_argument("--allow-service", action="store_true")
    automation_agent.add_argument("--ttl-hours", type=int, default=24)
    automation_agent.add_argument("--timeout-seconds", type=int, default=600)
    automation_agent.add_argument("--notify", action="store_true")
    automation_agent.add_argument("--json", action="store_true")
    ...
    watch_add.add_argument("--home", default=argparse.SUPPRESS)
    ...
    watch_list.add_argument("--home", default=argparse.SUPPRESS)
    ...
    watch_check.add_argument("--home", default=argparse.SUPPRESS)
